...
class DB
{
    ...
    private function __construct(
        ...
        try {
            $this->dbh = new PDO("mysql:host=" . $this->options['host'] . ";dbname=" . $this->options['db'] . ";charset=utf8", $this->options['user'], $this->options['password']);
    ...
    public function query($query, $args = [], $quick = false)
    {
        ...
        if ($quick == true) {
            ...
            if (strpos(strtoupper($query), "SELECT") === 0) {
                ...
                $rows = $stmt->fetchAll(PDO::FETCH_CLASS, Obj::class);
                $collection = [];
