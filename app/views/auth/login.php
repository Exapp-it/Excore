        ...
        <div class="flex justify-center self-center  z-10">
            <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
                ...
                <form @submit.prevent="loginRequest">
                    <div class="space-y-6">
                        <div class="">
                            <input x-model="login" :class="{'border-red-500': error.field === 'login'}" class="w-full px-3 py-2 border border-gray-300 rounded-md transition duration-500 focus:outline-none focus:border-indigo-500" type="text" placeholder="Введите логин">
                        </div>
                        ...
                        <div class="relative" x-data="{ show: true }">
                            <input x-model="password" :class="{'border-red-500': error.field === 'password'}" class="w-full px-3 py-2 border border-gray-300 rounded-md transition duration-500 focus:outline-none focus:border-indigo-500" placeholder="Password" :type="show ? 'password' : 'text'">
...
<script src="/front/auth/login.js"></script>