<footer class="gradient-gold shadow-2xl">
    <div class="main-container">
        <div class="mx-auto max-w-screen-xl sm:space-y-8 md:px-4 py-16 sm:px-6 space-y-16 px-8">
            <div class="grid sm:grid-cols-1 gap-8 grid-cols-3">
                ...
                <div class="grid sm:grid-cols-1 gap-8 md:grid-cols-2 col-span-2 grid-cols-4">
                    <div>
